 ...
 */
class participant_left extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' left round with id '{$this->other['roundid']}' " .
    ...
    public static function get_name() {
        return get_string('eventparticipantleft', 'mod_kahoodle');
    }
