 ...
 */
class round_created extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' created round with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventroundcreated', 'mod_kahoodle');
    }
