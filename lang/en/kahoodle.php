...
$string['finishgame'] = 'Finish game';
$string['finishgame_confirm'] = 'Are you sure you want to finish the game? This will end the round for all participants.';
$string['invalidstage'] = 'Invalid game stage';
$string['join'] = 'Join';
$string['kahoodle:addinstance'] = 'Add a new Kahoodle';
$string['kahoodle:control'] = 'Start and control a round of Kahoodle, display the main screen';
$string['kahoodle:manage_questions'] = 'Manage questions in Kahoodle';
$string['kahoodle:participate'] = 'Participate in a Kahoodle game';
$string['kahoodle:view'] = 'View Kahoodle';
$string['kahoodlesettings'] = 'Kahoodle settings';
$string['landing_controlinprogress_message'] = 'The game is currently in progress. You can resume facilitating or finish the game early.';
$string['landing_finished_message'] = 'The activity has finished.';
$string['landing_inprogress_message'] = 'The activity is in progress.';
...
$string['stage_leaders'] = 'Leaderboard';
$string['stage_leaders_placeholder'] = 'Leaderboard will be displayed here';
$string['stage_lobby'] = 'Lobby';
